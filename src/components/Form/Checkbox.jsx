...
const CheckboxIcon = ({ className = "", animated = false }) => {
   return (
      ...
      >
         <g strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="0" strokeWidth="1.8">
            <path
            ...
            <path
               ...
               className={`stroke-current text-white dark:text-transparent dark:group-has-[input:checked]:text-white ${
...
export default forwardRef(
   (
      ...
      return (
         <div className="checkbox grid gap-y-2 group">
            <label className={`text-sm leading-6 flex items-center select-none ${className}`}>
               <input
                  type="checkbox"
                  ref={ref}
                  id={name}
